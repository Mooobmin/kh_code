				...
				<form name="f_updateForm" id="f_updateForm">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td colspan="3"><textarea class="form-control" rows="8" id="content" name="content">${updateData.content}</textarea></td>
						</tr>
						<tr>
							<td class="text-center">비밀번호</td>
							<td colspan="3"><input type="password" class="form-control" id="passwd" name="passwd" placeholder="기존 비밀번호가 아니라 수정할 비밀번호를 입력해 주세요."/></td>							
						</tr>
					</table>
				</form>
			</div>
