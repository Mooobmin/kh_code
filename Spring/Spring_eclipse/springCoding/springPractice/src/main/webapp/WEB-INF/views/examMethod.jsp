	...
	<body>
		<div class="container">
			...
			<form id="example" class="form-horizontal">
				...
				<div class="form-group">
					<label for="no" class="col-sm-2 control-label">이 름</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="name" id="name" placeholder="이름 입력"/>
					</div>
				</div>
				<div class="form-group">
					<label for="no" class="col-sm-2 control-label">핸드폰</label>
					<div class="col-sm-10">
			...
			<form id="example" class="form-horizontal">
				...
				<div class="form-group">
					<label for="no" class="col-sm-2 control-label">소유자</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="owner" id="owner" placeholder="소유자 입력"/>
					</div>
				</div>
				<div class="form-group">
					<label for="no" class="col-sm-2 control-label">등 급</label>
					<div class="col-sm-10">
